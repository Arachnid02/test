#aliens.py will take two inputs from the user, the amount of aliens that landed
#on earth, and how many weeks have elapsed since they landed. With these two
#inputs, the program will calculate the alien population on earth.

#Fixed grammar issues with the program. Reduced variables that are not used.
